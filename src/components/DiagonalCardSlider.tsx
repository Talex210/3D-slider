...
const DiagonalCardSlider: React.FC = () => {
  ...
  const originalCards: CardData[] = [
    { 
      id: 1, 
      src: `${process.env.PUBLIC_URL}/imgCard/4182c3a36ae0287e74f45e4bc4b0478087395003.png`, 
    ...
    { 
      id: 2, 
      src: `${process.env.PUBLIC_URL}/imgCard/59ba5cf45380257ee8e166783aea5b97c3ea0cdc.png`, 
      alt: 'HR-сервис',
    ...
    { 
      id: 3, 
      src: `${process.env.PUBLIC_URL}/imgCard/7a09640693403a43979b9a4739084f32d370db3c.png`, 
    ...
    { 
      id: 4, 
      src: `${process.env.PUBLIC_URL}/imgCard/917b42be1295ce1f172cb33877e54f1dec65e57f.png`, 
    ...
    { 
      id: 5, 
      src: `${process.env.PUBLIC_URL}/imgCard/a45850229f15ef811703228f465820f420082051.png`, 
      alt: 'CRM система',
    ...
    { 
      id: 6, 
      src: `${process.env.PUBLIC_URL}/imgCard/ba47b00bf8270ce37d877ac1a7145dc748420631.png`, 
    ...
    { 
      id: 7, 
      src: `${process.env.PUBLIC_URL}/imgCard/d2e3ad2a21dceaaeafc305c81f44cd9f06b16da3.png`, 
      alt: 'IoT платформа',
